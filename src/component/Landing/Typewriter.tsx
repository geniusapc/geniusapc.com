        ...
        <TypewriterEffect
          ...
          onInit={(typewriter) => {
            typewriter
              ...
              .pauseFor(1000)
              .pasteString(
                '<br/> I am <span style="color:#ed9935">Prince Arthur</span>',
                null
              )
              .pasteString(
              ...
              .pauseFor(1000)
              .pasteString(
                '<br/> &nbsp -  <span style="color:#ed9935">Node.js</span>',
                null
              )
              .pasteString(
                '<br/> &nbsp  - <span style="color:#ed9935">React.js</span>',
                null
              )
              .pasteString(
                '<br/> &nbsp -  <span style="color:#ed9935">AWS</span>',
                null
              )
              .pauseFor(2000)
              .typeString("<br/> $ clear")
